...
const Playstore = () => {
  return (
    <section id="hero" className="py-1">
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-col justify-center items-center lg:w-1/2 order-2 lg:order-1 pt-5 lg:pt-0">
            <div className="mb-2 text-center">
              <h1 className="text-4xl md:text-3xl sm:text-2xl mb-6">Simi</h1>
              <h3 className="text-xl md:text-lg sm:text-base mb-6">Aprende Quechua de una manera amigable</h3>
              <a
              ...
              >
                <img src={GooglePlayLogo} className="max-w-xs sm:max-w-[60px] md:max-w-xs lg:max-w-xs h-auto" alt="Google Play" />
              </a>
            </div>
          </div>
